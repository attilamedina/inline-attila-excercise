...
<div class="main-container">
        ...
        <div class="content">
            ...
            <div class="content-body">
				...
				<?php
				echo "This is Attila Medina pipeline test assesment. Please validate the stage to deploy to production.";
				?>
				</div>
                <div class="description line-2">
				<?php
				$appType = "PHP";
				echo "This $appType app is up and running on Azure in container.";
				?>
				</div>
